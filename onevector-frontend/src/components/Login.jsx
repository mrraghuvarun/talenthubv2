    ...
    <div className="w-full">
      ...
      <div className="flex flex-col items-center pt-8 px-6">
        <div className="flex items-center gap-3 mb-6">
          <img src={TalentHubImage} alt="TalentHub Logo" className="w-8 h-8 md:w-10 md:h-10 object-contain" />
          <h1 className="text-2xl md:text-3xl font-semibold bg-gradient-to-r from-[#15BACD] to-[#094DA2] bg-clip-text text-transparent">TalentHub</h1>
        </div>
        <div className="mb-8 text-center">
          <h2 className="text-xl md:text-2xl font-medium text-gray-800 mb-3">Forgot your password?</h2>
          <p className="text-gray-600 text-sm md:text-base max-w-sm">No worries! Enter your email address and we'll send you instructions to reset your password.</p>
        </div>
      </div>
...
function Login() {
  ...
  const hasProcessedCode = useRef(false); // Track if code has been processed
  ...
  useEffect(() => {
    ...
    if (code && !hasProcessedCode.current) {
      ...
      handleMicrosoftCallback(code).then(() => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-r from-[#15BACD] to-[#094DA2] font-roboto text-lg">
      <div className="hidden md:flex flex-1 justify-center items-center relative bg-gradient-to-r from-[#15BACD] to-[#094DA2]">
        ...
        />
        <div className="absolute inset-0 flex justify-center items-center text-center text-white z-10"></div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white p-6 md:p-12 relative">
        <div className="w-full max-w-[450px] space-y-8 md:space-y-10">
          <div className="flex items-center space-x-4 animate-fade-in justify-center">
            ...
            />
            <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#15BACD] to-[#094DA2]">TalentHub</h1>
          </div>
            ...
            <p className="text-gray-600">
              ...
              <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogTrigger asChild>
                  <button className="text-[#15BACD] hover:text-[#094DA2] transition-colors duration-300 hover:underline focus:outline-none">
                    Reset it here
                  </button>
                </DialogTrigger>
